...
public class EsperEndpointPostprocessor implements BeanPostProcessor {
    ...
    private static final Logger log = Logger
	    .getLogger(EsperEndpointPostprocessor.class);
    ...
    /**
     * @param channelsToIntercept
     *            the channelsToIntercept to set
     */
	...
	public EsperChannelInterceptor() {
	    super();
	    EPServiceProvider esperServiceProvider = EPServiceProviderManager
		    .getDefaultProvider();
